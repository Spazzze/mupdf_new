package com.example.mupdf_new_example.old;
        ...
        layoutPopupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.action_layout_6pt:
                        layoutEm = 6;
                        break;
                    case R.id.action_layout_7pt:
                        layoutEm = 7;
                        break;
                    case R.id.action_layout_8pt:
                        layoutEm = 8;
                        break;
                    case R.id.action_layout_9pt:
                        layoutEm = 9;
                        break;
                    case R.id.action_layout_10pt:
                        layoutEm = 10;
                        break;
                    case R.id.action_layout_11pt:
                        layoutEm = 11;
                        break;
                    case R.id.action_layout_12pt:
                        layoutEm = 12;
                        break;
                    case R.id.action_layout_13pt:
                        layoutEm = 13;
                        break;
                    case R.id.action_layout_14pt:
                        layoutEm = 14;
                        break;
                    case R.id.action_layout_15pt:
                        layoutEm = 15;
                        break;
                    case R.id.action_layout_16pt:
                        layoutEm = 16;
                        break;
                }
